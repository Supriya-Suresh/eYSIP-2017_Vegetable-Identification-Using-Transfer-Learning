...
\section{Results}
The system works well while identifying vegetables with a distinct texture and color such as tomato, bittergourd, ladyfinger etc. However, while identifying similar-looking vegetables like fenugreek, basil and coriander, we found that the system tends to make mistakes and/or have low confidence.
